class FundsTransfer < ApplicationRecord
  ...
  as_enum :status_code, [:FAILED, :RETURNED_FROM_BENEFICIARY, :NEW, :SENT_TO_BENEFICIARY, :SCHEDULED_FOR_NEXT_WORKDAY, :IN_PROCESS, :COMPLETED, :ONHOLD, :Pending, :SettlementInProcess, :SettlementCompleted, :SettlementReversed], map: :string, source: :status_code
